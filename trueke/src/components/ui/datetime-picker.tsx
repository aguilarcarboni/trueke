  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'w-[48px] text-center font-normal text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none',
          className,
        )}
      ...
      <Popover>
        <PopoverTrigger asChild disabled={disabled}>
          <Button
            ...
            size="default"
            className={cn(
              'border-input dark:bg-input/30 dark:hover:bg-input/50 w-full justify-start px-3 py-2 text-left font-normal shadow-xs',
