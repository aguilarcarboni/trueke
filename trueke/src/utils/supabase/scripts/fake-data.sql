...
INSERT INTO notification (notification_id, recipient_user_id, sender_user_id, type, reference_type, reference_id, title, body, delivery_channel, status, priority, sent_at) VALUES
    ('44000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', NULL,                                         'account_created',    NULL,         NULL, 'Welcome to Trueke!',         'Your account is ready. Start trading!',                     'in_app', 'sent',    'normal', NOW() - INTERVAL '7 days'),
    ('44000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001',        'proposal_created',   'exchange',   '22000000-0000-0000-0000-000000000001', 'New Trade Proposal', 'Alice wants to trade with you!',          'in_app', 'sent',    'high',   NOW() - INTERVAL '6 days'),
    ('44000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002',        'proposal_accepted',  'exchange',   '22000000-0000-0000-0000-000000000001', 'Proposal Accepted!', 'Bob accepted your trade proposal.',       'in_app', 'sent',    'high',   NOW() - INTERVAL '5 days'),
    ('44000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002',        'rating_received',    'user_rating','22000000-0000-0000-0000-000000000001', 'You received a rating', 'Bob rated you 4/5.',                  'in_app', 'sent',    'normal', NOW() - INTERVAL '4 days'),
    ('44000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001',        'rating_received',    'user_rating','22000000-0000-0000-0000-000000000001', 'You received a rating', 'Alice rated you 5/5.',                'email',  'sent',    'normal', NOW() - INTERVAL '3 days'),
    ('44000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001',        'message_received',   'negotiation','ee000000-0000-0000-0000-000000000002', 'New Message',         'You have a new message from Alice.',      'in_app', 'queued',  'normal', NOW() - INTERVAL '2 days'),
    ('44000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000002', NULL,                                         'meeting_invite',     'meeting',    '11000000-0000-0000-0000-000000000001', 'Meeting Scheduled',   'A meeting has been set for your trade.',   'in_app', 'sent',    'high',   NOW() - INTERVAL '1 day');
